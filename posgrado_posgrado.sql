...
SET @@GLOBAL.GTID_PURGED=/*!80000 '+'*/ 'b8f369e9-6adc-11ee-9f1a-42010a400002:1-70170';
...
CREATE TABLE `posgrado` (
  ...
  UNIQUE KEY `posgrado_UNIQUE` (`posgrado`),
  UNIQUE KEY `idposgrado_UNIQUE` (`idposgrado`)
...
INSERT INTO `posgrado` VALUES (2,'Informatica','Cardoso Llano Leonardo'),(3,'Ciberseguridad Avanzada','Nuñez Garcia Gregorio');
...
-- Dump completed on 2023-10-18 17:25:02
